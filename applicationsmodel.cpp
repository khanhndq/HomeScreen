...
void ApplicationsModel::swapApplication(int from, int to)
{
...
//Copy list of application to reorder
void ApplicationsModel::copy() {
    m_reorderData = m_data;
}

// Get application from qml to add to QList
void ApplicationsModel::getApp(int index, QString title, QString url, QString iconPath) {
